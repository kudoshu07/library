      ...
      <div className="space-y-10 text-sm leading-relaxed text-foreground md:text-base">
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc space-y-1 pl-6">
            <li>新しい記事の公開通知（メールマガジン）</li>
            <li>月次ダイジェストの配信（メールマガジン）</li>
        ...
        <section className="space-y-3">
          ...
          <p>
            お預かりした情報は適切なセキュリティ対策のもと管理します。メールマガジンは配信停止後に速やかにデータを削除します。お問い合わせの内容は当サイトのデータベースには保存せず、通知メールとして受信・保管します。
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p>
            メールマガジンはメール内のリンクからいつでも配信を停止できます。お問い合わせ内容の開示・削除等については、受信したメールに記載の連絡先へご依頼ください。
          </p>
        </section>
      </div>
